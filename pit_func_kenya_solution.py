...
df.plot(x='emp_income', y=['atr1', 'atr2'])
# Selecting Rows of Database with Emplyment Income less than 12 million

df[df['emp_income']<15000000].plot(x='emp_income', y=['atr1', 'atr2'])
df[(df['emp_income']>6000000)&(df['emp_income']<15000000)].plot(x='emp_income', y=['atr1', 'atr2'])
